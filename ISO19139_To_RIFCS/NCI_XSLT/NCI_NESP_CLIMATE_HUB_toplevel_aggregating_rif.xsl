...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_group" select="'NESP Climate Hub (Hosted at National Computational Infrastructure)'"/> 
    ...
    <xsl:template match="*:MD_Metadata" mode="TOP_LEVEL">
        <xsl:message>NCI_RSES_toplevel_aggregating</xsl:message>
