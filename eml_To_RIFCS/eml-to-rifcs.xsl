    ...
    <xsl:element name="registryObject">
      ...
      <xsl:element name="collection">
        ...
        <xsl:element name="rights">
          ...
          <xsl:variable name="firstLine" select="normalize-space(substring-before(concat(intellectualRights/para, '&#x0A;'), '&#x0A;'))"/>
          ...
          <xsl:variable name="licence2">
            <xsl:if test="not($licence1)">
              <xsl:variable name="licenceText" select="intellectualRights/para"/>
          ...
          <xsl:element name="licence">
            ...
            <xsl:choose>
              <xsl:when test="$licence1">
                ...
                <xsl:value-of select="substring-after(intellectualRights/para, $firstLine)"/>
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of select="intellectualRights/para"/>
                <xsl:if test="intellectualRights/para=''">
