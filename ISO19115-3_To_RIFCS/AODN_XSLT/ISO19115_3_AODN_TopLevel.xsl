...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:param name="global_originatingSource" select="'Australian Ocean Data Network'"/>
    <xsl:param name="global_acronym" select="'AODN'"/>
    <xsl:param name="global_baseURI" select="'catalogue-aodn.prod.aodn.org.au'"/>
    ...
    <xsl:param name="global_publisherName" select="'Australian Ocean Data Network'"/>
