...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="oai_dc:dc"  mode="activity">
        ...
        <registryObject>
            ...
            <xsl:apply-templates select="dcterms:bibliographicCitation" mode="activity_key"/>
            ...
            <xsl:element name="activity">
                ...
                <xsl:apply-templates select="identifier.uri[not(contains(text(), 'hdl.handle'))]" mode="activity_identifier"/>
                <xsl:apply-templates select="dcterms:bibliographicCitation" mode="activity_identifier"/>
                
                <xsl:choose>
                    <xsl:when test="count(dcterms:bibliographicCitation) > 0">
                        <xsl:apply-templates select="dcterms:bibliographicCitation" mode="activity_location_url"/>
                    </xsl:when>
                    <xsl:when test="count(identifier.uri) > 0">
                        <xsl:apply-templates select="identifier.uri" mode="activity_location_url"/>
                    </xsl:when>
                </xsl:choose>
                ...
                <xsl:choose>
                    <xsl:when test="count(description) > 0">
                        <xsl:apply-templates select="description" mode="activity_description_full"/>
                    </xsl:when>
                    <xsl:when test="count(title) > 0">
                        <xsl:apply-templates select="title" mode="activity_description_brief"/>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <xsl:apply-templates select="coverage.temporal" mode="activity_coverage_temporal"/>
                
                <xsl:apply-templates select="rights.accessRights" mode="activity_rights_access"/>
                
                <xsl:apply-templates select="creator[starts-with(text(), 'PROV VA')]" mode="activity_relatedObject_agency"/>
    ...
    <xsl:template match="dcterms:bibliographicCitation" mode="activity_key">
        <key>
    ...
    <xsl:template match="identifier.uri" mode="activity_identifier">
        <identifier>
    ...
    <xsl:template match="dcterms:bibliographicCitation" mode="activity_identifier">
        <identifier type="uri">
    ...
    <xsl:template match="identifier.uri" mode="activity_location_url">
        <location>
            <address>
    ...
    <xsl:template match="dcterms:bibliographicCitation" mode="activity_location_url">
        <location>
            <address>
                <electronic type="url" target="landingPage">
                    <value>
    ...
    <xsl:template match="oai_dc:dc" mode="activity_name">
        <name type="primary">
            <namePart>
    ...
    <xsl:template match="coverage.temporal" mode="activity_coverage_temporal">
        <coverage>
            <temporal>
    ...
    <xsl:template match="rights.accessRights" mode="activity_rights_access">
        <rights>
            <accessRights>
                <xsl:attribute name="type">
                    <xsl:choose>
    ...
    <xsl:template match="creator" mode="activity_relatedObject_agency">
        <relatedObject>
            <key>
                <xsl:choose>
