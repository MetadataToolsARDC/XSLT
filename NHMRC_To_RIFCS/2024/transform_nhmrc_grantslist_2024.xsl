...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- version 2024 has updates:
     - takes different input file and has different element names for input file 
     ~/git/XSLT/NHMRC_To_RIFCS/2024/1-summary_of_results_2024_app_round_130723.xml -->


    <xsl:output method="xml"/>
    <xsl:variable name="AdminInstitutions" select="document('nhmrc_admin_institutions_manual_update_ror_id_2024.xml')"/>
    <!--xsl:variable name="grantpubs" select="document('nhmrc_grantpubs_2024.xml')"/--> <!-- I don't have one of these until I update the API call in https://github.com/MetadataToolsARDC/XSLT/blob/7b4e454b03b308331a686ac5f672be3192ce0c10/NHMRC_To_RIFCS/2024/trove_harvest_2024.xsl -->
