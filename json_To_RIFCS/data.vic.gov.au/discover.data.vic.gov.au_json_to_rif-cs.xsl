...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="results" mode="collection">
       ...
       <registryObject>
            ...
            <collection>
                ...
                <xsl:apply-templates select="date_created_data_asset" mode="collection_dates_created"/>
    ...
    <xsl:template match="date_created_data_asset" mode="collection_dates_created">
        <xsl:if test="string-length(normalize-space(.)) > 0">
